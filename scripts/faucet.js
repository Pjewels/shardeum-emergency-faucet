...
function enableMetamaskOnShardeum() {
  ...
  if(window.ethereum.networkVersion != 8081){
    alert("You are not on the Shardeum Testnet! Please switch to Shardeum and refresh page.")
...
function checkLastDateWithdrawn() {
  contractDefined_JS.methods.userPreviousWithdrawTime(accounts[0]).call((err, balance) => {
    ...
    if(balance === undefined){
      document.getElementById("getValueStateSmartContract").innerHTML =  "Install Metamask and select Shardeum Testnet to have a Web3 provider to read blockchain data."
    }
...
const contractABI_JS = [{"inputs":[],"name":"cooldown","type":"error"},{"inputs":[],"name":"faucetNotFunded","type":"error"},{"inputs":[],"name":"useFaucet","outputs":[],"stateMutability":"nonpayable","type":"function"},{"inputs":[{"internalType":"address","name":"","type":"address"}],"name":"userPreviousWithdrawTime","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"},{"stateMutability":"payable","type":"receive"}]
